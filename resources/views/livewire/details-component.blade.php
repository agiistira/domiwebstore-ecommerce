				...
				<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
					<div class="wrap-product-detail">
						...
						<div class="detail-info">
                            ...
                            @if ($product->sale_price > 0 && $sale->status=== 'active' && $sale->sale_date > Carbon\Carbon::now())
							...
							<div class="wrap-butons">
                                @if ($product->sale_price > 0 && $sale->status==1 && $sale->sale_date > Carbon\Carbon::now('Africa/Cairo'))
